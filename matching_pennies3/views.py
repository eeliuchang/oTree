...
class Introduction(Page):
    ...
    template_name = 'matching_pennies3/Introduction.html'
...
class Question1(Page):
    ...
    template_name = 'matching_pennies3/Question.html'
...
class Feedback1(Page):
    ...
    template_name = 'matching_pennies3/Feedback.html'
...
class Choice(Page):
    ...
    template_name = 'matching_pennies3/Choice.html'
...
class Results(Page):
    ...
    template_name = 'matching_pennies3/Results.html'
...
class ResultsSummary(Page):
    ...
    template_name = 'matching_pennies3/ResultsSummary.html'
